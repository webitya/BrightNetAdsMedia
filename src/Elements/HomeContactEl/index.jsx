...
const HomeContactEl = () => {
  const handleSubmit = (values) => {
    emailjs.send('brightnetadsmedia', 'template_3huhfr7', values, '0Hvj9yjpmUDpSmvbk')
      .then(() => {
    ...
    <div className="contact-page">
      ...
      <div className="contact-info grid grid-cols-1 md:grid-cols-3 gap-6 p-6">
        <div className="contact-card flex flex-col items-center bg-white p-6 rounded-lg shadow-lg">
          ...
          <p><a href="mailto:brightnetadsmedia@gmail.com">brightnetadsmedia@gmail.com</a></p>
        </div>
        <div className="contact-card flex flex-col items-center bg-white p-6 rounded-lg shadow-lg">
          <EnvironmentOutlined className="icon text-3xl text-green-600 mb-4" />
          <h3 className="text-xl font-semibold mb-2">Address</h3>
          <p className="text-center">Karam Chowk Harmu Ranchi,<br />Ranchi Jharkhand</p>
        </div>
        <div className="contact-card flex flex-col items-center bg-white p-6 rounded-lg shadow-lg">
